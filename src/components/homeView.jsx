...
export default function HomeView({ user, onLogout, onLogin, onOpenOCR, onOpenHIW }) {
    // HomeView ya no necesita Lucide directamente aquí, se gestiona en componentes específicos

    return (
        <main className="home-aeon">
            <HeroSection onOpenOCR={onOpenOCR} onOpenHIW={onOpenHIW} />
            <TrustSection />
            <HowItWorksSection />
            <VisualMappingSection />
            <FeaturesSection />
            <UseCasesSection />
            <FinalCTASection onOpenOCR={onOpenOCR} onOpenHIW={onOpenHIW} />
            <FooterSection />
        </main>
    );
}

function HeroSection({ onOpenOCR, onOpenHIW }) {
    return (
        <section className="aeon-hero aeon-container">
            <div>
                ...
                <div className="aeon-hero-btns">
                    <button onClick={onOpenOCR} className="aeon-btn-primary" title={window.t('home.hero.cta_primary')}>
                        {window.t('home.hero.cta_primary')}
                    </button>
                    <button onClick={onOpenHIW} className="aeon-btn-secondary" title={window.t('home.hero.cta_secondary')}>
        ...
        <section className="aeon-extraction" id="features">
            <div className="aeon-container aeon-extraction-grid">
                ...
                <div className="aeon-extraction-content">
                    ...
                    <button className="aeon-btn-primary" title={window.t('home.visual_mapping.cta')} style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', marginTop: '1rem' }}>
        ...
        <section className="aeon-bento aeon-container">
            <div className="aeon-bento-grid">
                ...
                <div className="aeon-bento-card aeon-bento-3">
                    ...
                    <p style={{ opacity: 0.9, fontSize: '1.125rem', color: '#ffffff' }}>{window.t('home.features.desc3')}</p>
                </div>
...
function FinalCTASection({ onOpenOCR, onOpenHIW }) {
    return (
        <section className="aeon-final-cta aeon-container">
            <div className="aeon-final-cta-box">
                <h2 className="aeon-final-cta-title">{window.t('home.final_cta.title')}</h2>
                <p className="aeon-final-cta-subtitle">{window.t('home.final_cta.subtitle')}</p>
                <div className="aeon-final-cta-btns">
                    <button onClick={onOpenOCR} className="aeon-btn-primary" title={window.t('home.final_cta.btn_primary')}>
                        {window.t('home.final_cta.btn_primary')}
                    </button>
                    <button onClick={onOpenHIW} className="aeon-btn-secondary" title={window.t('home.final_cta.btn_secondary')}>
            ...
            <div className="aeon-container">
                <div className="aeon-footer-grid">
                    <div className="aeon-footer-brand">
                        <div style={{ fontSize: '1.25rem', fontWeight: 'bold', color: '#131b2e', margin: '0 0 1rem' }}>{window.t('header_brand_name')}</div>
